...
export default function Confirm({ onGoHome }) {
  return (
    <div className="min-h-screen bg-[#e5e5e5] p-3 sm:p-6 lg:p-8">
      <div className="max-w-[980px] mx-auto min-h-screen lg:min-h-[730px] bg-[#fbfbfc] flex items-center justify-center">
        <div className="w-full max-w-[480px] min-h-[400px] sm:min-h-[480px] bg-white rounded-xl flex flex-col items-center justify-center px-6 sm:px-10">
          <div className="w-[90px] h-[90px] sm:w-[120px] sm:h-[120px] rounded-full bg-[#f4f3ff] flex items-center justify-center mb-8 relative">
          ...
          <p className="text-[15px] sm:text-[17px] text-[#111139] mb-7 text-center px-4">
