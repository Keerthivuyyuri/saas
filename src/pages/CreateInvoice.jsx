...
export default function CreateInvoice() {
  return (
    <div className="grid grid-cols-2 gap-8 bg-[#fafbff] min-h-screen px-9 py-8">
      {/* Left Form */}
      <div className="bg-white rounded-xl p-8">
        <h1 className="text-[26px] font-bold text-[#111139] mb-7">
          Create New Invoice
        </h1>

        <div className="w-[140px] h-[140px] rounded-full bg-[#f6f6f8] mx-auto flex items-center justify-center mb-8">
      ...
      <div className="bg-white rounded-xl p-8">
        <div className="flex justify-between mb-7">
          <h1 className="text-[26px] font-bold text-[#111139]">Preview</h1>
        ...
        <div className="bg-white border border-gray-100 min-h-[760px] p-10">
          ...
          <div className="flex justify-center gap-8 text-xs text-gray-500 mb-10">
            <p>BANK: <b>FTBUSS33</b></p>
            <p>IBAN: <b>GB82-1111-2222-3333</b></p>
          </div>
