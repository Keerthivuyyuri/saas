...
export default function CustomerList() {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[1fr_395px] bg-[#fafbff] min-h-screen">
      <div className="px-4 sm:px-6 lg:px-8 py-6 lg:py-9">
              ...
              {customers.map((item, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <p className="text-sm text-[#111139] truncate">
                      {item[0]}
                    </p>
                  </div>

                  <p className="text-sm text-[#111139] truncate">{item[1]}</p>
                  ...
                  {openMenu === index && (
                    <div className="absolute right-2 top-[45px] w-[105px] bg-white rounded-lg shadow-xl border border-gray-100 z-50 py-2">
        ...
        <p className="xl:hidden mt-3 text-xs text-gray-400">
          Swipe horizontally to view all customer details.
        </p>
      </div>

      {showAddCustomer ? (
        <aside className="fixed xl:static inset-y-0 right-0 z-50 w-full sm:w-[420px] xl:w-auto bg-white px-5 sm:px-8 py-8 lg:py-9 overflow-y-auto shadow-2xl xl:shadow-none">
          <div className="flex items-center justify-between mb-10 lg:mb-14">
            <h2 className="text-[20px] sm:text-[22px] font-bold text-[#111139]">
              Add Customer
            </h2>
          ...
          <div className="w-[110px] h-[110px] sm:w-[135px] sm:h-[135px] rounded-full bg-[#f5f5f8] mx-auto flex items-center justify-center mb-10 lg:mb-12">
            <Camera size={28} className="text-[#4b4b68]" />
          </div>

          <form className="space-y-5 max-w-md mx-auto xl:max-w-none">
            {["First Name", "Last Name", "Email", "Phone Number"].map(
              (label, index) => (
                <div key={label}>
                  <label className="text-sm text-[#111139]">{label}</label>
                  <input
                    defaultValue={
                      index === 0
                        ? "John"
        ...
        <aside className="bg-white px-5 sm:px-7 py-8 sm:py-10 border-t xl:border-t-0">
          ...
          <div className="py-8 border-b">
            ...
            <div className="space-y-6 text-sm text-gray-500">
              <div className="flex gap-4">
                ...
                <span className="break-all">kajop5128@ummoh.com</span>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-5 mt-6">
