      ...
      <div className={showAddProduct ? "opacity-40 pointer-events-none" : ""}>
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
            <select className="w-full sm:w-[150px] h-[42px] bg-white rounded-lg px-4 text-sm text-gray-500 outline-none">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="bg-white rounded-lg overflow-hidden w-fit">
          ...
          <button
            ...
            className="w-full sm:w-auto h-[44px] px-7 rounded-lg bg-[#5D5FEF] text-white text-sm flex items-center justify-center gap-2"
          >
            <Plus size={16} />
            Add Product
          </button>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_1fr] gap-8">
          <div className="min-w-0">
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8">
              <div className="flex items-center justify-between mb-7">
                <h2 className="text-[17px] sm:text-[20px] font-semibold text-[#111139]">
                  Top Selling Products
                </h2>
                <button className="text-[#5D5FEF] text-sm whitespace-nowrap">
                  See More
                </button>
              </div>
          ...
          <div className="space-y-8 min-w-0">
            <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8">
              <h2 className="text-[17px] sm:text-[20px] font-semibold text-[#111139] mb-7">
              ...
              <div className="space-y-5">
                {bars.map((bar, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-[35px_1fr_65px] sm:grid-cols-[35px_1fr_70px] items-center gap-3 text-sm"
                  >
                    ...
                    <span className="text-[#111139] text-xs sm:text-sm">
                      {bar[2]}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8">
              <div className="flex items-center justify-between mb-6 gap-4">
                <h2 className="text-[17px] sm:text-[20px] font-semibold text-[#555a7b]">
                  Product Sales Analytics
                </h2>
                <MoreHorizontal size={20} className="text-gray-400" />
              </div>

              <div className="h-[230px] sm:h-[260px] relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-blue-50 flex items-center justify-center text-blue-500">
                    ↗
                  </div>
                </div>
              </div>

              <div className="flex flex-wrap justify-center gap-4 sm:gap-5 text-xs sm:text-sm text-gray-500">
...
function AddProductPanel({ onClose }) {
  return (
    <div className="fixed lg:absolute top-0 right-0 w-full sm:w-[420px] lg:w-[380px] min-h-full bg-white z-50 px-5 sm:px-8 lg:px-9 py-8 sm:py-10 lg:py-12 shadow-2xl overflow-y-auto">
      <div className="flex items-center gap-5 sm:gap-8 mb-8 lg:mb-10">
        <button onClick={onClose} className="text-[#555a7b]">
          <ChevronLeft size={20} />
        </button>

        <h2 className="text-[18px] sm:text-[20px] font-bold text-[#111139]">
          Add a New Product
        </h2>
      </div>

      <div className="w-[105px] h-[105px] sm:w-[120px] sm:h-[120px] rounded-full bg-[#f6f6f8] mx-auto flex items-center justify-center mb-8 lg:mb-10">
      ...
      <div className="space-y-5 sm:space-y-6">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-5 mt-2">
            <input
              defaultValue="$1200"
              className="w-full sm:w-[145px] h-[52px] bg-[#f6f6f8] rounded-lg px-5 text-sm outline-none"
            />
...
function StatBox({ icon, title, value, note, color, bg, stroke }) {
  return (
    <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 h-[180px] sm:h-[190px] relative overflow-hidden">
      <div className="flex items-start gap-4 sm:gap-5">
        <div
          className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full ${bg} ${color} flex items-center justify-center shrink-0`}
        >
          {icon}
        </div>
        ...
        <div className="min-w-0">
          ...
          <h2 className="text-[24px] sm:text-[30px] font-bold text-[#555a7b] mt-2">
            {value}
          </h2>
        </div>
      </div>

      <div className="absolute bottom-0 left-0 w-full h-[70px] sm:h-[80px]">
        <ResponsiveContainer width="100%" height="100%">
