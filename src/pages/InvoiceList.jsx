...
export default function InvoiceList({ setActivePage }) {
  ...
  return (
    <div className="px-10 py-9 bg-[#fafbff] min-h-screen">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-[26px] font-bold text-[#111139]">Invoice List</h1>

        <div className="flex gap-5">
          <div className="w-[240px] h-[44px] bg-white rounded-xl flex items-center px-5">
            <input
              type="text"
              placeholder="Search"
              className="flex-1 outline-none text-sm text-gray-400"
            />
